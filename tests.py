class TestBooksCollector:
    ...
    def test_set_book_rating_to_five_changed_rating(self, book):
        ...
        assert 5 in book.get_books_rating().values()
    ...
    def test_get_books_with_specific_rating_shows_books(self, book):
        ...
        assert 'Гордость и предубеждение и зомби' in book.get_books_with_specific_rating(1) \
               and 'Что делать, если ваш кот хочет вас убить' in book.get_books_with_specific_rating(1)
    ...
    def test_add_book_in_favorites_added_book(self, book):
        ...
        assert book.get_list_of_favorites_books()[0] == 'Гордость и предубеждение и зомби'
